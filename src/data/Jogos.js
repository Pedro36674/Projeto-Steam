export const Jogos = [
    {
        ...
        description: 'Explore as paisagens vibrantes de mundo aberto do México com diversão e velocidade sem limites com os melhores carros do mundo.',
        price: 149.90,
        coverImage: 'https://cdn.forza.net/strapi-uploads/assets/FH_5_Evergreen_Key_Art_Horizontal_3840x2160_RGB_337636ab7f.jpg',
        bannerImage: 'https://playtracker.net/cdn-cgi/image/format=auto/https://playtracker-apollo.fra1.cdn.digitaloceanspaces.com/covers/api/game_cover_70470.jpg',
        category: 'Corrida',
        featured: false
    },
    {
    ...
    {
        id: 5,
        name: 'LEGO Batman: O Legado do Cavaleiro das Trevas',
        description: 'Assuma o papel do Cavaleiro das Trevas e viva a história essencial do Batman em uma aventura ousada e cheia de ação, com combate intenso, uma Gotham City de mundo aberto e o charme característico da LEGO que os fãs conhecem e amam.',
        price: 199.90,
        coverImage: 'https://image.api.playstation.com/vulcan/ap/rnd/202511/1118/f4e6951f2326e94a5f5d4bd4d54979f5421d6e34327849f2.jpg',
        bannerImage: 'https://www.lego.com/cdn/cs/set/assets/blt18519b2b57cf2876/02_LEGO_Dinner-dark_Hero-Standard_Desktop_v02.jpg',
        category: 'Ação',
        featured: false
    },
    {
    ...
    },
    {
        ...
        description: 'Viva a vida de um fora da lei no Velho Oeste, enfrentando desafios, fazendo escolhas e vivendo uma história épica de redenção.',
        price: 149.90,
        coverImage: 'https://cdn.akamai.steamstatic.com/steam/apps/1174180/capsule_616x353.jpg',
        bannerImage: 'https://cdn2.steamgriddb.com/hero/964e7520947a0d3ac39504daea604d83.png',
        category: 'Ação',
        featured: false
    }
]